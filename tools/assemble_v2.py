...
STAGING = {
    "coldopen": dict(music=0.35, lead=2.4, gap=0.3, tail=0.5, chapter=None, sfx=[
    ...
    "title": dict(music=0.5, lead=0.6, tail=1.0, chapter=None, sfx=[
        {**W, "gain": 0.9}, {"type": "shimmer", "at": "scene", "offset": 0.35, "gain": 0.8},
    ]),
    "stock": dict(music=0.6, lead=0.5, gap=0.3, tail=0.9, chapter="c01", sfx=[
    ...
    "installs": dict(music=0.7, lead=0.4, gap=0.3, tail=0.7, chapter="c01", sfx=[
    ...
    "quote": dict(music=0.45, lead=0.5, gap=0.45, tail=0.8, chapter="c02", sfx=[
        {**W, "gain": 0.8}, {"type": "shimmer", "at": "line:1", "offset": 0.1, "gain": 0.7},
    ]),
    "china": dict(music=0.7, lead=0.4, gap=0.3, tail=0.8, chapter="c02", sfx=[
    ...
    "usajapan": dict(music=0.72, lead=0.4, gap=0.3, tail=0.7, chapter="c02", sfx=[
    ...
    "labour": dict(music=0.55, lead=0.5, gap=0.4, tail=0.8, chapter="c03", sfx=[
    ...
    "hardtasks": dict(music=0.7, lead=0.4, gap=0.35, tail=0.8, chapter="c03", sfx=[
    ...
    "sectors": dict(music=0.82, lead=0.4, gap=0.3, tail=0.9, chapter="c03", sfx=[
    ...
    "forecast": dict(music=0.92, lead=0.4, gap=0.35, tail=1.1, chapter="c04", sfx=[
    ...
    "outro": dict(music=0.6, lead=0.5, gap=0.4, tail=5.2, chapter=None, sfx=[
